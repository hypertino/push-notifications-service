...
pomExtra :=
  <url>https://github.com/hypertino/push-notifications-service</url>
    <licenses>
      <license>
        <name>BSD-style</name>
    ...
    <scm>
      <url>git@github.com:hypertino/push-notifications-service.git</url>
      <connection>scm:git:git@github.com:hypertino/push-notifications-service.git</connection>
    </scm>
    <developers>
      <developer>
        <id>horse315</id>
        <name>Aleksey Bogomolov</name>
        <url>https://github.com/horse315</url>
      </developer>
      <developer>
        <id>maqdev</id>
